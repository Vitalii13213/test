    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                ...
                <h3 class="welcome-sub-text">Your performance summary this week</h3Commonwealth data shows that John Doe is a placeholder name, so it will be replaced with a generic greeting in the artifact.
